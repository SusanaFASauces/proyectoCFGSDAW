                ...
                <article>
                    <?php
                        ...
                        try {
                            ...
                            $mysqlImportFilename ='../scriptDB/ReestableceDAW208DBDepartamentos.sql'; //cadena que contiene el nombre del archivo sql que queremos ejecutar
                            ...
                            exec($command,$output=array(),$worked); //ejecutamos el comando
                            switch($worked) {
                                case 0:
                                    ...
                                    break;
                                case 1:
                                    echo "<p style=color:green>No han podido reestablecerse los resgistros de la tabla Departamento</p>"; //mostramos un mensaje indicando que se ha producido un error
                                    break;
                            }
                        }
