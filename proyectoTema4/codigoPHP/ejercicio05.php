    ...
    <body>
        ...
        <main>
            <section>
                ...
                <article>
                    <header>
                        <h4>Registros añadidos correctamente</h4>
                    </header>
                    <?php
                        /**
...
CONSULTA;
                            ...
                            $aParametros = [ //array que utilizaremos para bindear los parámetros de la consulta preparada
                                ":codDepartamento1" => "QUI", ":descDepartamento1" => "Departamento de química", ":volumenNegocio1" => 9,
                                ":codDepartamento2" => "MUS", ":descDepartamento2" => "Departamento de música", ":volumenNegocio2" => 3,
                                ":codDepartamento3" => "ELE", ":descDepartamento3" => "Departamento de electricidad", ":volumenNegocio3" => 12,
                            ];
                ...
                <article>
                    <header>
                        <h4>Error al añadir registros</h4>
                    </header>
                    <?php
                        /**
                         * @author Susana Fabián Antón
...
CONSULTA;
                            $insert = $miDB->prepare($consulta); //objeto de la clase PDOStatement que contiene una consulta preparada que le hacemos a la base de datos
                            $aParametros = [ //array que utilizaremos para bindear los parámetros de la consulta preparada
                                ":codDepartamento1" => "DES", ":descDepartamento1" => "Departamento de desarrollo", ":volumenNegocio1" => 9,
                                ":codDepartamento2" => "MUS", ":descDepartamento2" => "Departamento de música", ":volumenNegocio2" => 3,
                                ":codDepartamento3" => "CON", ":descDepartamento3" => "Departamento de construcción", ":volumenNegocio3" => 11,
                            ];
                            $num = $insert->execute($aParametros); //ejecutamos la consulta
                            $miDB->commit(); //confirmamos la transacción
                            echo "<p style=color:green>Los resgistros se han insertado en la tabla Departamento con éxito.</p>"; //mostramos un mensaje indicando que todo ha ido bien
